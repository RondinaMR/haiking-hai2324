...
def detect_intent():
    ...
    credentials = service_account.Credentials.from_service_account_file("haii-finalproject-e117566d75c1.json")
    ...
    session = session_client.session_path("haii-finalproject", 123456)
